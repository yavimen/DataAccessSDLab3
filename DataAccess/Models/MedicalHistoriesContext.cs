...
namespace DataAccess.Models
{
    public partial class MedicalHistoriesContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.Id).ValueGeneratedNever().IsRequired(true);

                entity.Property(e => e.Name).HasMaxLength(50).IsRequired(true);

                entity.Property(e => e.Surname).HasMaxLength(50).IsRequired(true);

                entity.Property(e => e.Department).HasMaxLength(50).IsRequired(true);

                entity.Property(e => e.Position).HasMaxLength(50).IsRequired(true);
            });
